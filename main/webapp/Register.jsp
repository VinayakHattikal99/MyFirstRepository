...
<body>
	...
	<section class="vh-100">
		<div class="container h-100"
			style="border-radius: 25px; height: 550px; padding: 2px 2px; width: 100%;">
			<div
						...
						<div class="card-body p-md-2">
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<form class="mx-1 mx-md-4" action="SaveRegistration"
										method="post">

										<div class="d-flex flex-row align-items-center mb-4">
											<i class="fas fa-user fa-lg me-3 fa-fw"></i>
											<div name="name" class="form-outline flex-fill mb-0">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div name="email" class="form-outline flex-fill mb-0">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div name="rep_password" class="form-outline flex-fill mb-0">
												<input name="rep_password" type="password"
